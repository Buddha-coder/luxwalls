export const metadata = {
    title: "Offline | LuxWalls",
    description: "You are offline. Please reconnect to continue browsing LuxWalls.",
  };
  
  export default function OfflinePage() {
    return (
      <main className="min-h-screen bg-[#0E0E11] flex items-center justify-center px-6">
        <div className="text-center max-w-sm">
          ...
          <p className="text-sm text-gray-400 mb-6">
            ...
            Please reconnect to continue exploring wallpapers.
          </p>
