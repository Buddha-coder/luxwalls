      ...
      <Container>
        <div className="flex h-20 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 lg:gap-12 text-sm font-medium text-soft-ivory/80">
            <Link href="/wallpapers" className="py-3 transition-all hover:text-white hover:-translate-y-px">
              Wallpapers
            </Link>
            <Link href="/about" className="py-3 transition-all hover:text-white hover:-translate-y-px">
              About
            </Link>
          </nav>
        </div>
