...
export default function ValueProposition() {
  return (
    <section className="w-full bg-background px-4 py-16 md:py-24 border-t border-border">
      <div className="mx-auto max-w-5xl">
        <div className="grid gap-12 text-center sm:grid-cols-3">
          <div className="flex flex-col items-center animate-fade-in [animation-delay:200ms]">
            ...
            <h3 className="mb-2 text-base md:text-lg font-semibold font-headline leading-tight">Curated for Quality</h3>
          ...
          <div className="flex flex-col items-center animate-fade-in [animation-delay:400ms]">
            ...
            <h3 className="mb-2 text-base md:text-lg font-semibold font-headline leading-tight">Designed for Devices</h3>
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
          ...
          <div className="flex flex-col items-center animate-fade-in [animation-delay:600ms]">
            ...
            <h3 className="mb-2 text-base md:text-lg font-semibold font-headline leading-tight">Effortless & Free</h3>
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
