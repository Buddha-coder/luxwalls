      ...
      <div className="flex gap-5 overflow-x-auto no-scrollbar px-6 md:px-[calc((100vw-1280px)/2+24px)] pb-10">
        {trendingWallpapers.map((wallpaper) => (
          <Link
            ...
            className="group relative flex-shrink-0 w-[190px] md:w-[260px] aspect-[9/16] rounded-[2.5rem] md:rounded-[3rem] overflow-hidden border border-white/5 transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] hover:border-primary/40 hover:-translate-y-2 hover:scale-[1.02] shadow-[0_30px_60px_rgba(0,0,0,0.8)]"
          >
            <Image
              src={wallpaper.src}
              alt={wallpaper.title}
              fill
              className="object-cover transition-transform duration-[1s] ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:scale-110"
              sizes="(max-width: 768px) 190px, 260px"
            />
            
            <div className="absolute inset-x-0 bottom-0 p-6 translate-y-4 opacity-0 transition-all duration-400 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:translate-y-0 group-hover:opacity-100 z-20">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-400 z-10" />
