...
export const buttonVariants = ({ variant, size, className }: VariantProps & {className?: string}) => {
    const variantKey = variant || buttonVariantsConfig.defaultVariants.variant;
    const sizeKey = size || buttonVariantsConfig.defaultVariants.size;

    return cn(
        buttonVariantsConfig.base,
        buttonVariantsConfig.variants.variant[variantKey],
        buttonVariantsConfig.variants.size[sizeKey],
        className
    )
}
