  ...
  return (
    <AnimateIn>
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 z-10 flex flex-col items-center justify-end pb-10 px-4 text-center">
          <div className="translate-y-3 group-hover:translate-y-0 transition-transform duration-700">
            <p className="text-[9px] font-bold text-white/60 uppercase tracking-[0.3em] leading-relaxed line-clamp-2">
              {wallpaper.title}
            </p>
          </div>
        </div>
